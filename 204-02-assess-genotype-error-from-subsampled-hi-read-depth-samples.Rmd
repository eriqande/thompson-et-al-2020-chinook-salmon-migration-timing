...
```
Now, we will bring the `intermediates/204-02/re-annotated` directory back to my laptop, and we will also grab
`intermediates/204-02/entire-vcfs/full-depth-for-beagle-reheadered.vcf.gz` and put it there.
